!bquote
`gbox-cellfiltering` is a gbox that provides a number of gboxes from Python. It is part of the standard gbox set.
!equote
...
$ gx installGbox.sh granatumx/gbox-cellfiltering:1.0.0  # Install this gbox
